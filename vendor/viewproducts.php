                ...
                <div class="box-body">
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Discribtion</th>
                            <th style="text-align: center">Cate_Tyoe</th>
                        ...
                        while($arr1=mysqli_fetch_array($rslt1))
                        {
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"><?php echo "<i class=\"fa fa-edit\"></i> <a href='editproduct.php?cnm=$cnm'>Edit</a>";?></td>
                                <td style="text-align: center"><?php  echo "<i class=\"fa fa-remove\"></i> <a href='process/deleteprod.php?cnm=$cnm'>Delete</a>"; ?></td>
                            </tr>
                        <?php }?>
                        </tfoot>
                    </table>
