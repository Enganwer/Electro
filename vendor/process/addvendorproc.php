...
if (isset($_POST["un"])&&isset($_POST["pw"])&&isset($_POST["fname"])&&isset($_POST["mob"])&&isset($_POST["address"]))
{
    ...
    if ($_FILES["img"]["size"] >0 )
    {
        ...
        $qry = mysqli_query($cn , "insert into users (user_name, password, full_name, mobile, role, adress, img) values('$un','$pw','$fname','$mob','vendor','$address','$img_name1');");
...
else echo  header("location:../login.php?error=invalid");
