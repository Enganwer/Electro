				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="fcategory.php?fcat=1" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Head Phones<br>Collection</h3>
								<a href="fcategory.php?fcat=5" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="fcategory.php?fcat=7" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
                            ...
                            ?>
										...
										<div class="product">
											...
											<div class="product-body">
												<h3 class="product-name"><a href="product.php?id=<?php echo $pid ?>">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<a class="primary-btn cta-btn" href="product.php?id=13">Shop now</a>
						</div>
					</div>
				</div>
				<!-- /row -->
